    ...
    <div class="tz-gallery">
        ...
        session_start();
                 ...
                 $eventid=$_GET["eventid"]; 
                    $sql = mysqli_query($con,"SELECT * FROM `tblsmartkidsgallery` where eventid='$eventid' ");
		...
		?>
            ...
            <div class="col-sm-12 col-md-4">
                <a class="lightbox" href="../Daycare/images/<?php echo $display["photo"] ?>">
                    <img src="../Daycare/images/<?php echo $display["photo"] ?>" >
                </a>
            </div>
