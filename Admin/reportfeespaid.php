...
<body>
<form action="Excel/excelfeespaid.php" method="post">
<div class="logo">
              <a href="./index.php">
                <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
  ...
  <div class="row">
  <div class="col-md-12" style=" margin-left: 90px; border-radius:15px; top: 106px;    margin-bottom: 59px;">
  ...
  <h2 style="text-align: center;margin-top: 6%;font-family: fantasy;">FEES PAID CHILDREN</h2>
...
include("config.php");
$s=1;
$sql="select c.childname,c.parentname,d.daycarename from (select c.*,p.parentname from tblsmartkidschildren c inner join tblsmartkidsparents p on c.parentid=p.parentid) c inner join tblsmartkidsdaycare d on c.daycareid=d.daycareid";
