...
<body>
<form action="Excel/excelmalestaff.php" method="post">
<div class="logo">
              <a href="./index.php">
                <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
  ...
  <h2 style="text-align: center;margin-top: 6%;font-family: fantasy;">MALE STAFFS</h2>
...
include("../config.php");
$s=1;
$sql="SELECT s.staffname,s.email,s.contactno,d.daycarename FROM `tblsmartkidsstaff` s inner join tblsmartkidsdaycare d on s.daycareid=d.daycareid where s.gender='M'";
