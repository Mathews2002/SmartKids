			...
			<div class="top-nav w3-agiletop">
				<div class="container">
					<div class="navbar-header w3llogo">
						...
						<h1><a href="index.php">Learn Kids</a></h1> 
					</div>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<div class="w3menu navbar-right">
							<ul class="nav navbar">
								...
								<li><a href="childview.php">Details</a></li>
								<li><a href="parentlogin.php">View Progress</a></li>
								<li><a href="stafflogin.php">Payment</a></li>
